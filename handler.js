...
$(document).ready(function() {
    document.title = config.preGameScreen.titleText;
});
...
window.draw = function() {
    ...
    } else if (Howler.state == "running" && window.currentScreen == "gameScreen" && !window.sounds.theme.playing() && window.soundEnabled) {
        window.sounds.theme.play();
    }
